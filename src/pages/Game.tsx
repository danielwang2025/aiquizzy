        ...
        <div className="container mx-auto max-w-5xl">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Engage with our educational games designed to enhance reading speed and strategic thinking skills.
            </p>
          </motion.div>

          <div className="glass-effect rounded-2xl overflow-hidden border border-white/20 shadow-lg">
            <Tabs defaultValue="speed-reading" className="w-full">
              <TabsList className="w-full justify-center mb-6">
                <TabsTrigger value="speed-reading">Speed Reading</TabsTrigger>
                <TabsTrigger value="snake">Snake Game</TabsTrigger>
              </TabsList>
              
              <TabsContent value="speed-reading">
                <SpeedReadingGame />
              </TabsContent>
              
              <TabsContent value="snake" className="flex justify-center p-4">
                <SnakeGame />
              </TabsContent>
            </Tabs>
          </div>
