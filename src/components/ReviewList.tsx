                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {question.difficulty && (
                        <Badge variant="outline" className={cn(
                          "border-none", 
                          ["easy", "remember"].includes(question.difficulty) ? "bg-green-100/70 text-green-800" : 
                          ["medium", "understand", "apply"].includes(question.difficulty) ? "bg-amber-100/70 text-amber-800" :
